# VideoCompress
A Telegram Video Compressor Bot By [@Kristy_Offl](https://t.me/ML_SupportGroup). **This bot works for all!** No need to define each user IDs to use bot. Also works in Group.
...
* If you need more help to Deploy Feel Free to ask in [Support Group](https://t.me/@ML_SupportGroup).
...
### Support Group:
<a href="https://t.me/ML_SupportGroup"><img src="https://img.shields.io/badge/Telegram-Join%20Telegram%20Group-blue.svg?logo=telegram"></a>
...
## Optional Configs:
* `UPDATES_CHANNEL` - Put your Channel Username which you want to do Force Sub. But bot should be Admin in that channel. If got any error or not understand anything than ask in [Support Group](https://t.me/ML_SupportGroup).
...
## Follow on:
<p align="left">
<a href="https://github.com/Kristy-offl"><img src="https://img.shields.io/badge/GitHub-Follow%20on%20GitHub-inactive.svg?logo=github"></a>
</p>
<p align="left">
